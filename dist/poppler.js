...
export function popplerVersion() {
    try {
...
export function popplerWarning() {
    const found = popplerVersion();
    if (found === EXPECTED_POPPLER)
        return null;
    return (`poppler ${found}, expected ${EXPECTED_POPPLER} — extraction output can ` +

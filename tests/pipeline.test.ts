...
import { splitPage, collapseDoubleSpacing } from "../src/clean";
import {
  toBlocks,
  blocksToMarkdown,
  mergeAcrossPages,
...
import { autoFix, findSuspects } from "../src/ocr";
import {
  structuralChecks,
  losslessCheck,
  retentionCheck,
...
import { runningFurniture } from "../src/passes";
...
describe("headings that wrap", () => {
  ...
  it("recognises a title cut off mid-phrase", async () => {
    const { danglesMidPhrase } = await import("../src/paragraphs");

...
| `jack-smith-note-p14.txt`, `jack-smith-note-p66.txt` | `jack-smith-report/archive/Report-of-Special-Counsel-Smith-Volume-1…pdf` | 14, 66 | Run-overs at the rule's edges: only three body lines above the notes (p.14); a two-line run-over only one blank below the body (p.66) (reportsthatmatter-g1f) |
